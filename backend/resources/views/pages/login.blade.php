...
<head>
    ...
    <!-- Preload halaman register untuk transisi instan -->
    ...
    <style>
        * {
        ...
        .bg-slide:nth-child(3) {
            background-image: url('https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?auto=format&fit=crop&w=1600&q=80');
        }

        .bg-slide:nth-child(4) {
            background-image: url('https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?auto=format&fit=crop&w=1600&q=80');
        }
        ...
        .bg-overlay {
            ...
            right: 0;
            bottom: 0;
            background: linear-gradient(135deg, rgba(26, 26, 46, 0.88) 0%, rgba(78, 205, 196, 0.7) 100%);
            z-index: 1;
        }
    ...
    <div class="auth-container">
        ...
        <div class="auth-left">
            ...
            <div class="auth-left-content">
                ...
                <h1 class="auth-tagline">Temukan Gaya Unik<br>dengan Thrift Pilihan.</h1>
                <p class="auth-description">Ribuan koleksi vintage menunggu. Bergabung sekarang dan temukan penawaran
                    eksklusif khusus member.</p>
            </div>
        </div>
        ...
        <div class="auth-right">
            <div class="auth-form-container">
                <!-- Tab Toggle -->
                <div class="auth-tabs">
                    <a href="javascript:void(0)" class="auth-tab active" data-page="login">Masuk</a>
                    <a href="javascript:void(0)" class="auth-tab" data-page="register">Daftar</a>
                </div>

                <!-- Form Header -->
                <div class="auth-header">
                    <h2 class="auth-title">Selamat Datang Kembali <span class="emoji">👋</span></h2>
                ...
                <form id="loginForm" class="auth-form">
                    ...
                    <p id="loginStatus" class="form-error">Email atau password salah.</p>
                ...
                <!-- Social Login -->
                <button type="button" class="btn-social" onclick="alert('Fitur Google Login akan segera hadir!')">
                ...
                <div class="auth-footer">
                    Belum punya akun? <a href="javascript:void(0)" class="auth-nav-link" data-page="register">Daftar
                        sekarang</a>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const redirectAfterLogin = async () => {
                ...
                if (safeNext) {
                    clearNext();
                    navigateWithTransition(next.trim());
                    return;
                }
