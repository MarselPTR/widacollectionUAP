    ...
    <div class="relative bg-gradient-to-br from-primary via-secondary to-dark text-white">
        <div class="max-w-6xl mx-auto px-4 py-12 pb-32 md:pb-40 space-y-6">
            <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                <div>
                    <p class="text-sm uppercase tracking-[0.35em] text-white/70 wc-reveal" style="--reveal-delay: 40ms;">Dashboard Thrifting</p>
                    <h1 class="text-4xl font-bold wc-reveal" style="--reveal-delay: 120ms;">Profil Pengguna</h1>
                    <p class="text-white/80 wc-reveal" style="--reveal-delay: 190ms;">Pantau aktivitasmu mulai dari riwayat pesanan, wishlist, hingga preferensi live drop.</p>
                </div>
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="cart.html" class="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white text-primary font-semibold shadow-lg wc-reveal" style="--reveal-delay: 300ms;">
    ...
    <main class="relative z-10 max-w-6xl mx-auto px-4 -mt-20 md:-mt-32 pb-16 space-y-10">
        <section class="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 md:p-8 flex flex-col lg:flex-row gap-8">
            <div class="flex flex-col items-center text-center gap-4 lg:w-1/3">
                ...
                <div>
                    <h2 id="profileName" class="text-2xl font-semibold text-dark">Wida Bagaskara</h2>
                    <p id="profileBio" class="text-gray-500">Collector & Style Curator</p>
                </div>
                <div class="flex flex-wrap justify-center gap-3 text-sm text-gray-500">
                    <span id="profileTier" class="px-3 py-1 rounded-full bg-light text-dark font-medium">Member Wida Collection</span>
                    <span id="profileSince" class="px-3 py-1 rounded-full bg-primary/10 text-primary font-medium">Since 2021</span>
                </div>
            ...
            <div class="flex-1 grid sm:grid-cols-2 gap-6">
                <div class="bg-gradient-to-br from-light to-white rounded-2xl border border-white shadow p-5 space-y-3">
                    ...
                    <p id="profileEmail" class="text-dark font-semibold">widacollection@gmail.com</p>
        ...
        <section class="grid lg:grid-cols-2 gap-8">
            <div class="bg-white rounded-3xl shadow border border-gray-100 p-6 space-y-5">
                <div class="flex justify-between items-center">
                    ...
                    <a href="orders.html" class="text-primary text-sm font-semibold">Lihat Semua</a>
                </div>
            ...
            <div class="bg-white rounded-3xl shadow border border-gray-100 p-6 space-y-5">
                <div class="flex justify-between items-center">
                    ...
                    <a href="edit-profile.html#addressForm" class="text-primary text-sm font-semibold">Kelola Alamat</a>
                </div>
            ...
            <div class="bg-white rounded-3xl shadow border border-gray-100 p-6 space-y-5">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="wishlist.html" class="inline-flex items-center gap-1 px-4 py-2 rounded-full border border-primary/40 text-primary text-sm font-semibold hover:bg-primary/5 transition">
                            <i class="fas fa-list-check"></i>
                            Kelola Wishlist
                        </a>
                        <a href="body.html#products" class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary text-white text-sm font-semibold shadow hover:bg-primary/90 transition">
                ...
                <p id="wishlistEmpty" class="text-sm text-gray-400 hidden">Belum ada item wishlist. Tambahkan melalui katalog produk.</p>
            </div>
        </section>
    </main>
