...
<body class="gradient-page font-poppins">
    <div class="form-card">
        <h2 class="text-2xl font-bold text-center mb-6 text-dark wc-reveal" style="--reveal-delay: 80ms;">Login ke <span class="text-primary">Wida Collection</span></h2>
        <form id="loginForm">
        ...
        <div class="text-center mt-4">
            <span class="wc-reveal" style="--reveal-delay: 240ms;">Belum punya akun? <a href="register.html" class="link-login">Daftar</a></span>
        </div>
    </div>
