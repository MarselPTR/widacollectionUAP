...
<body class="font-poppins bg-gray-50 min-h-screen relative">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-4 py-12 space-y-8">
        <header class="text-center space-y-4">
            <div class="inline-flex items-center justify-center rounded-full bg-primary/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-primary wc-reveal"
                style="--reveal-delay: 40ms;">
                <i class="fas fa-circle-check mr-2"></i> Pembayaran sukses
            </div>
            <p class="text-sm font-semibold text-primary wc-reveal" style="--reveal-delay: 100ms;">Wida <span
                    class="text-secondary">Collection</span></p>
            <h1 class="text-3xl md:text-4xl font-bold text-dark wc-reveal" style="--reveal-delay: 160ms;">Terima kasih
                sudah berbelanja di Wida Collection</h1>
            <p class="text-gray-500 max-w-2xl mx-auto wc-reveal" style="--reveal-delay: 230ms;">Pesanan kamu sedang kami
                proses. Rincian di bawah ini juga dikirim ke email/WhatsApp yang kamu masukkan saat checkout.</p>
        </header>
        ...
        <div class="flex flex-wrap justify-center gap-4">
            <a href="body"
                class="inline-flex items-center gap-2 rounded-full bg-secondary text-white px-8 py-3 font-semibold shadow hover:bg-secondary/90 wc-reveal"
                style="--reveal-delay: 280ms;">
                <i class="fas fa-house"></i> Kembali beranda
            </a>
            <a href="profile"
                class="inline-flex items-center gap-2 rounded-full border border-gray-200 px-8 py-3 font-semibold text-gray-600 hover:border-primary hover:text-primary wc-reveal"
        ...
        <div id="successFallback" class="hidden text-center space-y-3">
            ...
            <a href="body"
                class="inline-flex items-center gap-2 rounded-full bg-primary text-white px-6 py-3 font-semibold">Mulai
                belanja</a>
        </div>
    </div>
